...
class U_I18N_API FunctionOptions : public UObject {
 public:
     ...
     * @deprecated This API is for technology preview only.
     */
    U_I18N_API FunctionOptionsMap getOptions() const {
     ...
     * @deprecated This API is for technology preview only.
     */
    U_I18N_API FunctionOptions mergeOptions(const FunctionOptions& other, UErrorCode&) const;
    /**
     * Default constructor.
     ...
     * @deprecated This API is for technology preview only.
     */
    U_I18N_API FunctionOptions() { options = nullptr; }
    /**
     * Destructor.
     *
     * @internal ICU 75 technology preview
     * @deprecated This API is for technology preview only.
     */
    U_I18N_API virtual ~FunctionOptions();
    /**
     * Non-member swap function.
     * @param f1 will get f2's contents
     * @param f2 will get f1's contents
     ...
     * @deprecated This API is for technology preview only.
     */
    U_I18N_API friend inline void swap(FunctionOptions& f1, FunctionOptions& f2) noexcept {
        using std::swap;
     ...
     * @deprecated This API is for technology preview only.
     */
    U_I18N_API FunctionOptions& operator=(FunctionOptions) noexcept;
    /**
     * Copy constructor.
     *
     * @internal ICU 75 technology preview
     * @deprecated This API is for technology preview only.
     */
    U_I18N_API FunctionOptions(const FunctionOptions&);
 private:
