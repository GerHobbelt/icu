...
enum {
    ...
    UNEWTRIE2_INDEX_2_NULL_OFFSET=(int)UNEWTRIE2_INDEX_GAP_OFFSET + (int)UNEWTRIE2_INDEX_GAP_LENGTH,

    /** The start of allocated index-2 blocks. */
    UNEWTRIE2_INDEX_2_START_OFFSET=(int)UNEWTRIE2_INDEX_2_NULL_OFFSET + (int)UTRIE2_INDEX_2_BLOCK_LENGTH,
